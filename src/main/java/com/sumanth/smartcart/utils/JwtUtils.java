package com.sumanth.smartcart.utils;

import com.sumanth.smartcart.constants.ApplicationConstants;
...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication){
        String jwt;
        String secret = env.getProperty(ApplicationConstants.JWT_SECREAT_KEY,
